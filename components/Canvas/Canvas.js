...
import {Text, View, PanResponder, ART, requireNativeComponent, InteractionManager, Image} from 'react-native';
...
class Canvas extends PureComponent{
  ...
  render(){
    ...
    return(
        <View
          ref={this.parentView} >
          {this.state.show&&<NativeCanvas
            onLayout={this._onLayout}
            {...this._panResponder.panHandlers}
            backgroundColor="rgb(240,240,240)"
            ref={this.nativeCanvas}
            onToBase64={this.getBase64}  style={this.props.canvasStyle}>
            <ART.Shape d={this.state.path} stroke="#000000" strokeWidth={this.props.strokeWidth} />
          </NativeCanvas>}
        </View>
    )
  }
