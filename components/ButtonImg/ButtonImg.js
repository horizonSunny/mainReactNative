...
import {
	...
	StyleSheet,
	ImageBackground,
	TouchableNativeFeedback, ImageSourcePropType, GestureResponderEvent, Platform
} from 'react-native'
...
export default class ButtonImage extends React.Component<ButtonImgInterface,ButtonImgState> {
	constructor(props) {
		super(props)
	}
	static defaultProps = {
	...
	shouldComponentUpdate(nextProps,nextState){
		return this.props.source!==nextProps.source || this.state.source!==nextState.source;
	};
		...
		if(this.props.type==='ripple'){
			return (
				<TouchableNativeFeedback
					background={Platform.Version<21?TouchableNativeFeedback.SelectableBackground():TouchableNativeFeedback.Ripple(this.props.rippleColor?this.props.rippleColor:'#a2a4a6',false)}
					style={{flex: 1}}
				...
				>
					<View style={[styles.button,this.props.style?this.props.style:null]}>
