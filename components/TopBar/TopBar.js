...
export default class TopBar extends React.PureComponent {
	...
	render() {
		...
		if(this.props.rootStore.userInfo.name){
			userInfo=<View style={{flexDirection: 'row', alignItems: 'center'}}>
				<Text style={styles.name}>{this.props.rootStore.userInfo.name}</Text>
				<Text style={styles.sex}>[{this.props.rootStore.userInfo.sex=="1"?"男":"女"}</Text>
			...
			<View style={[styles.container]}>
				<ImageBackground source={require('./img/top.png')} style={styles.bk}>
					...
					<View style={{flexDirection: 'row'}}>
						...
						<ButtomImg
							...
							style={{width: dp(36), height: dp(38), marginLeft: dp(40), marginRight: dp(40)}}
				...
				<Modal animationType="slide"
					...
					<View
						...
						<View style={{width: dp(730), height: dp(450), backgroundColor: '#ffffff'}}>
							<View style={{flexDirection: 'row', justifyContent: 'flex-end',backgroundColor:'#406dce',height:dp(100)}}>
								<Text style={{fontSize: font(38),marginTop:dp(20),marginRight:dp(440),color:'#fff'}}>温馨提示</Text>
							...
							<View style={{
								...
								flex: 1,
								justifyContent: 'center',
								marginTop: dp(0),flexDirection:'row'
							}}>
								<Image style={{width: dp(66), height: dp(66),marginRight: dp(50),}}
								       source={require('./img/!.png')}/>
								<Text style={{fontSize: font(40),color:'#333'}}>是否退出本测验</Text>
							</View>
							<View style={{flexDirection: 'row'}}>
								<View style={{width:'50%',boxSizing:'border-box',borderRightWidth:dp(0.5),borderColor:'#e6e6e6',height:dp(130),borderTopWidth:dp(1)}}>
									<PrevButton text="确定" onPress={this.exitApp} buttonStyle={{
										color: "#406dce",
										marginLeft: dp(50),
										width:dp(250),
										height:dp(70),
								...
								<View style={{width:'50%',boxSizing:'border-box',borderLeftWidth:dp(0.5),borderColor:'#e6e6e6',height:dp(130),borderTopWidth:dp(1)}}>
									<PrevButton  text="取消"  onPress={this.cancelExit} buttonStyle={{
										color: "#406dce",
