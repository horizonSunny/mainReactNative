  ...
  render(){
    return(
      <ButtonImg
        ...
        style={styles.buttonNum} source={require('../../../assets/img/num.png')}>
  ...
  render(){
    return(
      <View style={this.props.style}>
       <View style={{width:dp(570),height:dp(450),paddingLeft:dp(60),paddingRight:dp(60)}}>
          <View style={styles.buttonWrap}>
            ...
            <ButtonImg
              ...
              <Text style={[styles.buttonText,{color:'#ffffff'}]}>删除</Text>
            </ButtonImg>
            <NumberButton onPress={this.onPressNumber.bind(this,0)} text={0}/>
            <ButtonImg
              onPress={this.handleEnsure}
              style={styles.buttonStyle} source={require('../../../assets/img/ensure.png')}>
