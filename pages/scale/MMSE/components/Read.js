...
export default class Read extends React.Component {
  ...
  componentWillMount() {
    ...
    let questionInfo = {
      closeEyes: objectClone(answerModel)
    };
  ...
  calculateScore = () => {
    ...
    questionInfo["closeEyes"]["score"] = parseInt(
      questionInfo["closeEyes"]["answer"]
    );
      ...
      <View style={{ marginTop: dp(30) }}>
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <Text style={{ fontSize: font(140) }}>闭上眼睛</Text>
                </View>
              </View>
            </View>
          </Modal>
        ...
        <View style={styles.table}>
          ...
          <View>
            ...
            <View style={styles.tableRow}>
              <Radio.RadioGroup
                model={this.state.questionInfo["closeEyes"]["answer"]}
                onChange={this.keyBoardChange.bind(this, "closeEyes")}
              >
        ...
        <View style={{ alignItems: "center", marginTop: dp(130) }} />
