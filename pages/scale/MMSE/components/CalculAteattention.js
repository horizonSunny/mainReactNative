...
export default  class CalculAteattention extends React.Component{
	constructor(props){
		...
		console.log('reduceSeven_'+this.state.reduceSeven);
	 ...
	 */
	goNext=()=>{
			const noEmpty = (this.state.reduceSeven === 5 && this.state.answers.mmse12s1 === '') || 
	...
	reduce(){
		// if(this.state.reduceSeven === 5){
			return (
				<React.Fragment>
					{this.state.reduceSeven>4 && <View style={{flexDirection:'row',justifyContent:'flex-end',marginTop:dp(45)}}>
						<Image source={require('./img/xh.png')} style={{width: dp(40),
							height: dp(40),marginTop:dp(25),marginRight:dp(45)}}></Image>
					...
					{this.state.reduceSeven<=4 && <View style={{height:dp(150)}}></View> }
					{this.state.reduceSeven>3 && <View style={{flexDirection:'row',justifyContent:'flex-end',marginTop:dp(45)}}>
					...
					{this.state.reduceSeven>2 && <View style={{flexDirection:'row',justifyContent:'flex-end',marginTop:dp(45)}}>
						<Text style={{fontSize:font(60)}}>继续减7=</Text>
						<TextInput
							textContentType="telephoneNumber"
							placeholderTextColor="#434343"
					...
					{this.state.reduceSeven>1 && <View style={{flexDirection:'row',justifyContent:'flex-end',marginTop:dp(45)}}>
						<Text style={{fontSize:font(60)}}>继续减7=</Text>
						<TextInput
							textContentType="telephoneNumber"
							placeholderTextColor="#434343"
					...
					{this.state.reduceSeven>0 && <View style={{flexDirection:'row',justifyContent:'flex-end',marginTop:dp(45)}}>
						<Text style={{fontSize:font(60)}}>继续减7=</Text>
						<TextInput
							textContentType="telephoneNumber"
							placeholderTextColor="#434343"
