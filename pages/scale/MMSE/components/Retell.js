...
export default class Retell extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      questionModel: "retell",
      questionIndex: 14
    };
  }
  componentWillMount() {
    ...
    let questionInfo = {
      retell: objectClone(answerModel)
    };
  ...
  calculateScore = () => {
    ...
    questionInfo["retell"]["score"] = parseInt(
      questionInfo["retell"]["answer"]
    );
      ...
      <View style={{ marginTop: dp(30) }}>
        ...
        <View style={styles.table}>
          ...
          <View>
            ...
            <View style={styles.tableRow}>
              <Radio.RadioGroup
                model={this.state.questionInfo["retell"]["answer"]}
                onChange={this.keyBoardChange.bind(this, "retell")}
              >
