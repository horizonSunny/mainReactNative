...
export default class Named extends React.Component {
  ...
  calculateScore = () => {
    ...
    questionInfo["watches"]["score"] = parseInt(
      questionInfo["watches"]["answer"]
    );
    questionInfo["pencil"]["score"] = parseInt(
      questionInfo["pencil"]["answer"]
    );
    ...
    return (
      <View style={{ marginTop: dp(30) }}>
        <View style={{ backgroundColor: "#fff", marginTop: dp(50) }}>
          ...
          >
            <Text style={[styles.questionText, { lineHeight: dp(230) }]}>
              请您说出右侧物品的名称
            </Text>
            <View
              style={{
            ...
            >
              <ButtonImg
                ...
                source={require("./img/shoubiao.png")}
                sourcePress={require("./img/audio-press.png")}
              />
              <ButtonImg
                style={{
                  width: dp(230),
        ...
        <View style={[styles.table]}>
          <View style={styles.tableColumn1}>
            <Image
              style={{ width: dp(250), height: dp(300) }}
              source={require("./img/doctor1.png")}
            />
          </View>
          <View style={{ height: dp(300) }}>
            ...
            <View style={styles.tableRow}>
              <Text style={[styles.td, styles.tdb]}>词1</Text>
              <Radio.RadioGroup
                model={this.state.questionInfo["watches"]["answer"]}
                onChange={this.keyBoardChange.bind(this, "watches")}
              >
            ...
            <View style={styles.tableRow}>
              <Text style={[styles.td, styles.tdb]}>词2</Text>
              <Radio.RadioGroup
                model={this.state.questionInfo["pencil"]["answer"]}
                onChange={this.keyBoardChange.bind(this, "pencil")}
              >
                <View style={styles.td}>
                  <Radio value={1} style={styles.radio} />
                </View>
